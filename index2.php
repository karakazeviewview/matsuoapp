...
<head>
<meta charset="UTF-8">
<title>ソースコードの入力｜ソースコード送信フォーム</title>
</head>
<body>
...
<p><label>ソースコード：(複数ファイルの場合はフォルダ構造もご記載ください)<br>
<textarea name="naiyou" cols="140" rows="1000"><?=$naiyou?></textarea>
